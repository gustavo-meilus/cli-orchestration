...
Before the first public release, only current `main` is considered for security fixes. Replace this with an explicit version table when a supported release exists.
